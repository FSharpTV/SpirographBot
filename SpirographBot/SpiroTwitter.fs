...
//    open System.Net.Http
    ...
    *)
    ...
    let setDescription () =
        let name = "Spirograph Robobot"
        let url = "http://spirobot.azurewebsites.net"
        ...
        let description = sprintf "Proudly delivering artisanal spirographs with F# since %s [%s]" time version
